...
class FlashcardApp:
    ...
    def info(self):
        ...
        # info window construction (styled like rest of app)
        ...
        # display info text inside frame
    ...
    def manage_flashcards(self):
        ...
        # helper for making styled buttons
        ...
        # canvas + scrollbar for flashcard rows
